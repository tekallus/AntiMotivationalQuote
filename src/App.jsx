  ...
  return (
    <div className="wrapper" style={currentData.image.wrapperStyles}>
      ...
      >
        <p
          className="quote"
          style={getSmallestFontSize(currentData.text, currentData.image)}
        >
...
//1)currentData.image.wrapperStyles'ı style özelliği üzerinden wrapper sınıfına ekleyerek, görüntüye özgü stil bilgilerini uygulamış olduk.
//2)currentData.image.containerStyles'ı style özelliği üzerinden quote-container sınıfına ekleyerek, görüntüye özgü konteyner stili bilgilerini uygulamış olduk.
//3)getSmallestFontSize fonksiyonunu kullanarak, currentData.text ve currentData.image arasındaki en küçük font boyutunu belirleyip, <p> elementine uyguladık.
